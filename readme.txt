...
Stage 2 is adding mouse support that also moves the in-game cursor.
...
TODO: I think I can probably shebang this with something like `#!/bin/pico8` or `#!usr/bin/env`
